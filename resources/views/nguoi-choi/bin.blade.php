...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mt-3 mb-3">Danh Sách Người Chơi Đã Xóa</h4>
                <table id="basic-datatable-1" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr> 
                            ...
                            <td>
                                <a href="{{ route('nguoi-choi.restore',$nguoiChoi->id) }}" class="btn btn-info waves-effect waves-light"><i class="fas fa-trash-restore"></i></a>
                                <!--<a href="{{ route('quan-tri-vien.delDt', ['id' => $nguoiChoi->id]) }}" class="btn btn-danger waves-effect waves-light"><i class="fas fa-trash"></i></a>-->
                            </td>                           
                        </tr>
                        @endforeach
                    </tbody>
